...
import ExplicacionCosto from "./ExplicacionCosto";
      ...
      <div className="flex items-center gap-2">
        <span
          className={`inline-flex items-center rounded-md ${
            proveedor.logoFondo ? `${proveedor.logoFondo} px-2 py-1` : ""
          }`}
        >
          <Image
            src={proveedor.logo}
        ...
        <div className="flex flex-col gap-2 sm:flex-[3]">
          {file ? (
            ...
            <button
              ...
              className={`flex flex-1 flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed px-4 py-8 text-center transition-colors ${
                arrastrando
